    ...
    <div className="card border-0 shadow-sm mb-3">
      <div className="card-body p-3">
        <div className="w-100 d-flex flex-column gap-3">
          <TwoDiv>
            <div className="text-primary fw-semibold flex-shrink-0">#{diary?.id}</div>
            <div className="fw-semibold text-body text-end flex-grow-1">{diary?.title}</div>
          </TwoDiv>
          <div
            className="text-body"
          ...
          />
          <TwoDiv>
            <div className="fst-italic text-secondary small">작성자: {diary?.nickname}</div>
